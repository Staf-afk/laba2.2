...
public:
    void testConstructor() {
        ...
        assertEqual((size_t)0, list1.GetLength(), "Конструктор по умолчанию - длина");
        std::cout << "    Создан пустой список" << std::endl;
        
        int items[] = {10, 20, 30, 40, 50};
        LinkedList<int> list2(items, 5);
        assertEqual((size_t)5, list2.GetLength(), "Конструктор из массива - длина");
        ...
        assertEqual((size_t)5, list3.GetLength(), "Конструктор копирования - длина");
        assertEqual(10, list3.GetFirst(), "Конструктор копирования - первый элемент");
        
        LinkedList<int> list4(std::move(list2));
        assertEqual((size_t)5, list4.GetLength(), "Конструктор перемещения - длина");
        assertEqual((size_t)0, list2.GetLength(), "Конструктор перемещения - источник опустошён");
    }
    ...
    void testAppendPrepend() {
        ...
        list.Append(10);
        assertEqual((size_t)1, list.GetLength(), "Append первого элемента - длина");
        ...
        list.Append(20);
        assertEqual((size_t)2, list.GetLength(), "Append второго элемента - длина");
        assertEqual(10, list.GetFirst(), "Append второго элемента - первый не изменился");
        assertEqual(20, list.GetLast(), "Append второго элемента - последний обновлён");
        printList(list, "После Append(20)");
        
        list.Prepend(5);
        assertEqual((size_t)3, list.GetLength(), "Prepend элемента - длина");
    ...
    void testGetSubList() {
        ...
        assertEqual((size_t)5, sublist1->GetLength(), "Подсписок [0-4] - длина");
        ...
        assertEqual((size_t)5, sublist2->GetLength(), "Подсписок [5-9] - длина");
        ...
        assertEqual((size_t)4, sublist3->GetLength(), "Подсписок [3-6] - длина");
    ...
    void testConcat() {
        ...
        assertEqual((size_t)6, combined->GetLength(), "Concat - правильная длина");
    ...
    void testCopyAssignment() {
        std::cout << "\n--- Тесты копирующего присваивания LinkedList ---" << std::endl;
        ...
        assertEqual(5, list2.GetFirst(), "Копирующее присваивание - первый элемент");
        assertEqual(15, list2.GetLast(), "Копирующее присваивание - последний элемент");
        
        printList(list1, "Оригинал после присваивания");
        printList(list2, "Копия после присваивания");
        
        std::cout << "    Копирующее присваивание создало глубокую копию" << std::endl;
        
        list2 = list2;
        assertEqual((size_t)3, list2.GetLength(), "Самоприсваивание");
    }
    
    void testMoveAssignment() {
        std::cout << "\n--- Тесты перемещающего присваивания LinkedList ---" << std::endl;
        ...
        assertEqual(1, list2.GetFirst(), "Перемещающее присваивание - первый элемент");
        assertEqual((size_t)0, list1.GetLength(), "Перемещающее присваивание - источник опустошён");
        
        printList(list2, "После перемещения");
    }
