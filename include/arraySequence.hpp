...
public:
    ...
    MutableArraySequence(DynamicArray<T>* arr) : ArraySequence<T>(std::move(*arr)) { delete arr; }
};
...
public:
    ...
    ImmutableArraySequence(DynamicArray<T>* arr) : ArraySequence<T>(std::move(*arr)) { delete arr; }
